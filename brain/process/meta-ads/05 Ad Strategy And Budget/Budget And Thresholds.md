...
| Attribution | **Aggregated Event Measurement** as the reporting view; SKAdNetwork configured alongside | AEM reports near real time — with **1-day click only** for install-optimised iOS 14+ ad sets (7-day click is offered only for app-event or value optimisation; Ads Manager refuses any other value after publishing, verified 2026-09-26); SKAN reports with "delays of at least 24 hours", campaign-level aggregates, statistical modelling at ad level, and A/B tests only at campaign level ([SKAN reporting](https://www.facebook.com/business/help/584603712214119), [AEM vs SKAN](https://www.facebook.com/business/help/1356268495231843)) |
