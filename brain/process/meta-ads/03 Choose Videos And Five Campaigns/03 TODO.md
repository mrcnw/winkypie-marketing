...
Documentation: [[03 Choose Videos And Five Campaigns]]

- [x] Pull the top-scoring hooks from [[02 How To Find A Good Ad]].
- [x] Map each candidate hook to a persona (P1 Restart / P2 Grinder / P3 Camera-Shy).
- [x] Choose five. Write down why the ones you dropped were dropped.
- [x] Name the single variable each campaign tests.
- [x] Decide the format per campaign: UGC, screen demo, static, before/after.
